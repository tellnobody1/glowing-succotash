...
object validate {
  def of10[L,A1,A2,A3,A4,A5,A6,A7,A8,A9,A10,B](a1: Either[L,A1], a2: Either[L,A2], a3: Either[L,A3], a4: Either[L,A4], a5: Either[L,A5], a6: Either[L,A6], a7: Either[L,A7], a8: Either[L,A8], a9: Either[L,A9], a10: Either[L,A10])(f: (A1,A2,A3,A4,A5,A6,A7,A8,A9,A10) => B): Either[Vector[L],B] = {
  ...
  def of9[L,A1,A2,A3,A4,A5,A6,A7,A8,A9,B](a1: Either[L,A1], a2: Either[L,A2], a3: Either[L,A3], a4: Either[L,A4], a5: Either[L,A5], a6: Either[L,A6], a7: Either[L,A7], a8: Either[L,A8], a9: Either[L,A9])(f: (A1,A2,A3,A4,A5,A6,A7,A8,A9) => B): Either[Vector[L],B] = {
  ...
  def of8[L,A1,A2,A3,A4,A5,A6,A7,A8,B](a1: Either[L,A1], a2: Either[L,A2], a3: Either[L,A3], a4: Either[L,A4], a5: Either[L,A5], a6: Either[L,A6], a7: Either[L,A7], a8: Either[L,A8])(f: (A1,A2,A3,A4,A5,A6,A7,A8) => B): Either[Vector[L],B] = {
